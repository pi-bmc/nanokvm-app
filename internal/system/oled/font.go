...
// Asc2_0806 is the 6x8 pixel ASCII font table.
// Index 0 corresponds to ' ' (space), with subsequent entries for printable ASCII.
var Asc2_0806 = [92][6]byte{
	...
	{0x00, 0x00, 0x28, 0x10, 0x28, 0x00}, // * (rendered as x)
	...
	{0x00, 0x55, 0x2A, 0x55, 0x2A, 0x55}, // backslash (checkerboard)
...
// Asc2_0804 is the 4x8 pixel ASCII font table (compact).
// Index 0 corresponds to ' ' (space).
var Asc2_0804 = [62][4]byte{
	...
	{0x00, 0x7c, 0x44, 0x00}, // [
	{0x28, 0x54, 0x28, 0x54}, // backslash (checkerboard)
	{0x00, 0x44, 0x7c, 0x00}, // ]
}

// Asc2_1608 is the 8x16 pixel ASCII font table.
// Index 0 corresponds to ' ' (space), through '~' (index 94).
var Asc2_1608 = [95][16]byte{
